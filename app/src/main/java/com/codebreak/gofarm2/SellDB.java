...
public class SellDB {
    ...
    public static final String KEY_NAME="city";
    public static final String KEY_DP="dp";
    public static final String KEY_PHN="phn";
    public static final String KEY_COUNT="count";

    private final String DATABASE_NAME="SellDB";
    private final String DATABASE_TABLE="SellTable";
    ...
    private class DBHelper extends SQLiteOpenHelper
    {
        ...
        public void onCreate(SQLiteDatabase db) {
            String sqlCode="CREATE TABLE "+DATABASE_TABLE+" ("+KEY_COUNT+" INTEGER PRIMARY KEY AUTOINCREMENT, "+KEY_ID+" TEXT NOT NULL, "+KEY_CROP+" TEXT NOT NULL, "+
                    KEY_DP+" TEXT NOT NULL, "+KEY_NAME+" TEXT NOT NULL, "+KEY_PHN+" TEXT NOT NULL, "+KEY_MARKET+" TEXT NOT NULL, "+KEY_AMT+" TEXT NOT NULL);";
            db.execSQL(sqlCode);
        }
    ...
    public SellDB open() throws SQLException
    {
